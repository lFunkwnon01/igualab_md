...
> ⚖️ **Actualización post-actas (05-09):** esta nota es **histórica y de contexto estratégico**. El alcance vigente quedó definido en las [[21 Actas de Reunión y Acuerdos|actas 1–3]]: Portal RAG sobre la base del cliente, sectores Minería/Energía/Petróleo, máx. 3 usuarios, sin LinkedIn, suscripción en 2ª fase. Resumen en [[12 Análisis y Recomendaciones]] (sección post-actas).
...
## 🔗 LinkedIn (exploratorio) — ❌ ELIMINADO del alcance (post-actas)
...
- Agenda de citas: sincronizar con `consultas@igualab.org` (estilo Google Meet con invitados preestablecidos). Referencia histórica: RF-10/RF-19, hoy fuera del alcance. Ver [[14 Requerimientos del Kick-off (RF-11+)]].
...
- ~~**Próxima reunión: viernes 28 a las 10:00** → presentar mockup de requerimientos + solución.~~ ✅ **Realizada (28-08)**; mockups entregados (ver [[20 Prompt Mockup MVP]]). Siguiente hito: 04-09 presentación del Plan de Proyecto ([[09 Planificación y Roadmap]]).
