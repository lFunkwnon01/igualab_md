...
## 🏢 Sobre Igualab
- **Nombre:** Igualab
- **Fundada:** 02 de noviembre de 2016
- **Naturaleza:** Organización **sin fines de lucro, 100% peruana**
- **Fines sociales:** educación y cultura
- **Objetivo general:** impulsar la transformación de organizaciones y comunidades mediante la **gestión integral de impacto**, combinando:
  - Consultoría estratégica
  - Educación certificada
  - Gestión operativa de fondos
...
- El análisis se haría con un **agente RAG** sobre esa información, el cual generaría **reportes** automatizados (ver [[04 Requerimientos Funcionales#RF-07 — Generación de Reportes|RF-07]]).
...
> Relación con la plataforma: los objetivos del onepager alimentan el módulo de [[04 Requerimientos Funcionales#RF-10 — Chatbot de Citas Fase 2|RF-10]].
