...
\grupo{Términos de negocio y dominio}
\glos{ASG (Ambiental, Social y Gobernanza)}{Dimensiones que evalúan el desempeño en sostenibilidad de una empresa.}
\glos{Brecha GRI}{Situación en la que un código o indicador GRI aplicable al sector de una empresa no se encuentra reportado, o se reporta con evidencia insuficiente.}
...
\glos{Sectores habilitados}{Los tres sectores acordados con el cliente para los cuales el sistema ejecuta el análisis de brechas: Minería, Petróleo y Gas, y Energía.}

\grupo{Términos de roles y control de acceso}
...
\grupo{Términos técnicos y de sistema}
...
\glos{JWT (JSON Web Token)}{Token firmado por el servidor que incorpora la identidad de la cuenta y su rol vigente, utilizado para mantener la sesión autenticada.}
...
\grupo{Términos metodológicos (SCRUM)}
...
\grupo{Términos del documento de Análisis y Diseño (RN / RF / RNF)}
