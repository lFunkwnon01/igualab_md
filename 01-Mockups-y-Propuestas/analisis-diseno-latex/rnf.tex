...
\hline
RNF-031 & Continuidad & Se realizan copias de seguridad diarias de la base de datos (incluido el índice vectorial) y de los documentos \texttt{.md} originales. & RF-016 \\
\hline
RNF-032 & Privacidad & El sistema cumple los controles básicos de protección de datos personales (Ley 29733). & Transversal \\
\hline
RNF-033 & Observabilidad & Los registros técnicos incluyen niveles y correlación por \texttt{request\_id}; los errores no exponen trazas al usuario. & Transversal \\
\hline
\end{longtable}
