...
\hline
\endhead
1 & Autenticación y Gestión de Sesión & CU001 & RN-004…RN-013 · RF-001…RF-005 · RNF-001…RNF-006, RNF-008, RNF-009 \\
\hline
...
\hline
4 & Ingesta de Documentos & CU003 & RN-018…RN-026 · RF-012…RF-017, RF-022 · RNF-007, RNF-011, RNF-015, RNF-016, RNF-020, RNF-025, RNF-028, RNF-029, RNF-030 \\
\hline
5 & Análisis y Validación de Brechas GRI & CU005 & RN-027…RN-032 · RF-018…RF-021, RF-028 · RNF-014, RNF-026 \\
\hline
6 & Asistente de IA (RAG) & CU004 & RN-033…RN-037 · RF-023, RF-024 · RNF-010, RNF-017, RNF-018, RNF-019, RNF-027 \\
\hline
...
Exclusivo del SuperAdmin: permite crear cuentas de Administrador asignando una contraseña inicial. El Administrador puede cambiar su contraseña cuando lo desee, tanto desde su sesión activa como mediante la recuperación de acceso con «¿Olvidaste tu contraseña?»; el sistema no exige un cambio de contraseña en el primer acceso. También permite habilitar o deshabilitar cuentas, invalidar sus sesiones activas y transferir el rol SuperAdmin a una cuenta de Administrador existente y habilitada, con confirmación previa y ejecución atómica. El sistema garantiza en todo momento la existencia de exactamente una cuenta con rol SuperAdmin y no contempla eliminación permanente de cuentas, solo habilitación y deshabilitación, para preservar la trazabilidad de auditoría.

\subsubsection{Módulo 3 --- Catálogo de Empresas}
Exclusivo del SuperAdmin: registra las empresas sobre las cuales se realizará el análisis, exigiendo nombre y sector. El sector es un atributo de la empresa y pertenece a un conjunto cerrado de tres valores (Minería, Petróleo y Gas, Energía); las empresas de otros sectores no son elegibles para el análisis ni para la generación de reportes.
