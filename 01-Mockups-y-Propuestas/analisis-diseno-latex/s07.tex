...
\subsection{Actores}
\textbf{SuperAdmin:} usuario con privilegios totales sobre la plataforma. Gestiona las cuentas (creación, habilitación, deshabilitación y asignación de roles) y es responsable del catálogo de empresas y de la ingesta de memorias anuales y reportes de sostenibilidad al sistema, incluida la validación de su correcta indexación.

\medskip
\textbf{Administrador:} usuario operativo encargado de la explotación analítica del sistema. Consulta al asistente de IA (RAG) en lenguaje natural, revisa y valida las brechas GRI y sanciones por empresa, y genera reportes de prospección en PDF para apoyar el acercamiento comercial de Igualab.
...
\figframe{Diagrama de caso de uso --- CU002}{\includegraphics[width=0.72\textwidth]{img/im-022-013.png}}
\figframe{Prototipo --- CU002}{\includegraphics[width=0.9\textwidth]{img/im-022-014.png}}
\figframe{Prototipo --- CU002}{\includegraphics[width=0.62\textwidth]{img/im-023-016.png}}
...
\figframe{Diagrama de caso de uso --- CU003}{\includegraphics[width=0.72\textwidth]{img/im-025-018.png}}
\figframe{Prototipo --- CU003}{\includegraphics[width=0.62\textwidth]{img/im-026-019.png}}
\figframe{Prototipo --- CU003}{\includegraphics[width=0.92\textwidth]{img/im-026-020.png}}
...
\frow{Flujo Alternativo}{\textbf{Información no encontrada}\newline Al devolver la información o respuesta pedida, si el documento o información pedida no existe, la IA deberá informar en su respuesta que no existe o no se encuentra, no inventarse información para cumplir con lo pedido.}
...
\figframe{Diagrama de caso de uso --- CU004}{\includegraphics[width=0.72\textwidth]{img/im-028-021.png}}
\figframe{Prototipo --- CU004}{\includegraphics[width=0.85\textwidth]{img/im-028-022.png}}
...
\figframe{Diagrama de caso de uso --- CU005}{\includegraphics[width=0.72\textwidth]{img/im-030-024.png}}
\figframe{Prototipo --- CU005}{\includegraphics[width=0.9\textwidth]{img/im-031-025.png}}
...
\ficha{
\frow{Descripción}{En este caso de uso el Administrador tiene la capacidad de generar reportes de prospección, los cuales contienen el código GRI, las sanciones de la empresa en dicho año y su puntaje ESG.}
\frow{Actores}{Administrador}
\frow{Precondiciones}{-- El Administrador debe haber iniciado sesión exitosamente.\newline -- Debe encontrarse en el módulo de reportes de prospección.\newline -- El documento del que se generará el reporte debe encontrarse en el sistema.}
...
\frow{Flujo Alternativo}{\textbf{Generar reporte de un año que no haya documento}\newline El sistema no habilita la vista previa, generación o descarga del documento ya que no hay posibilidad de hacerlo.\par\vspace{4pt}\textbf{Generar un reporte de un documento previamente usado}\newline El sistema no permitirá generar un reporte de un documento del cual ya se haya hecho un reporte.}
...
\frow{Restricciones}{-- Solo el rol Administrador puede acceder a este módulo.\newline -- El documento del cual se hará el reporte debe existir en el sistema.\newline -- No es posible generar un documento del mismo año, empresa y sector.}
\frow{Casos de Uso Padre}{CU005 --- Detección de Brechas GRI y Sanciones}
}
\figframe{Diagrama de caso de uso --- CU006}{\includegraphics[width=0.85\textwidth]{img/im-032-027.png}}
\figframe{Prototipo --- CU006}{\includegraphics[width=0.9\textwidth]{img/im-032-028.png}}
...
\figframe{Diagrama de caso de uso --- CU007}{\includegraphics[width=0.72\textwidth]{img/im-033-030.png}}
\figframe{Prototipo --- CU007}{\includegraphics[width=0.9\textwidth]{img/im-034-031.png}}
...
\begin{center}\includegraphics[width=0.85\textwidth]{img/im-034-033.png}\end{center}

\addcontentsline{toc}{subsubsection}{Gestión de Usuarios}
\noindent\textbf{Caso de uso:} Gestión de Usuarios
\begin{center}\includegraphics[width=0.85\textwidth]{img/im-035-034.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{img/im-036-035.png}\end{center}

\addcontentsline{toc}{subsubsection}{Consulta al Asistente de IA}
\noindent\textbf{Caso de uso:} Consulta al Asistente de IA
\begin{center}\includegraphics[width=0.85\textwidth]{img/im-037-036.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{img/im-038-037.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{img/im-039-038.png}\end{center}
