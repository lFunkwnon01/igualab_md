...
La arquitectura de Igualab se estructura en **tres capas principales**:
...
- API RESTful que expone funcionalidades principales
- Motor de procesamiento síncrono para:
  - Ingesta y validación de documentos
  - Análisis de indicadores GRI
...
- Servicio de generación de reportes de prospección (PDF)
- Módulo de auditoría para registrar todos los eventos del sistema
- Servicio de autenticación con validación de JWT

#### Capa de Datos
- **Base de datos relacional** (PostgreSQL) con esquema normalizado
- **Índice de búsqueda semántica** para documentos indexados
- **Almacenamiento de corpus documental** con embedding de contenido
