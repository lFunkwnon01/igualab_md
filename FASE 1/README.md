...
| Carpeta | Contenido |
|---|---|
| `01-Analisis-y-Diseno/` | antecedentes y objetivos · análisis GRI · **diagramas de procesos TO-BE (BPMN + mermaid)** · reglas de negocio (38) · requerimientos funcionales (53) · no funcionales (30) — numeración = A&D v5 · casos de uso (9 + mermaid) · especificaciones |
