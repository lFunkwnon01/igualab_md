...
| `02-Arquitectura-de-Solucion/` | **arquitectura de solución POR CAPAS (7 capas, ver `arquitecturasolution.jpeg`)** · arquitectura por módulos (**RAG simple, sin MCP**) + compara RAG vs MCP · modelos gratis sin function calling · **diagrama y diseño de la base de datos (2 bases PostgreSQL 16: transaccional + vectorial con pgvector; 13 tablas)** · diccionario de datos (13 tablas) · **`06-Diseño-Arquitectonico.md`** (informe de diseño arquitectónico por capas) · **`06-Modelo-de-Datos-Informe.md`** (informe completo del modelo de datos: conceptual → lógico → físico) |
